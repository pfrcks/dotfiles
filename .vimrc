...
"let g:ale_fixers = {'python': ['remove_trailing_lines', 'trim_whitespace', 'isort', 'autopep8'], 'typescript' : ['tslint']}
let g:ale_fixers = {'python': ['trim_whitespace'], 'typescript' : ['tslint']}
